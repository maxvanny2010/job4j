...
insert into rules (name_rule)
values ('7');
insert into roles_rules (id_roles_fk, id_rules_fk)
values ('1', '1');
insert into roles_rules (id_roles_fk, id_rules_fk)
values ('1', '2');
insert into roles_rules (id_roles_fk, id_rules_fk)
...
insert into roles_rules (id_roles_fk, id_rules_fk)
values ('3', '1');
insert into users (id_roles_rules_fk, name_user)
values (1, 'Java');
insert into users (id_roles_rules_fk, name_user)
values (2, 'Class');
insert into users (id_roles_rules_fk, name_user)
...
insert into itemCategory (name_category)
values ('warn');
insert into itemCategory (name_category)
values ('error');
insert into itemCategory (name_category)
values ('fatal');
insert into itemState (name_state)
values ('start');
insert into itemState (name_state)
values ('pass');
insert into itemState (name_state)
values ('end');
insert into itemAttach (name_attach)
values ('red');
insert into itemAttach (name_attach)
values ('yellow');
insert into itemAttach (name_attach)
values ('green');
insert into itemComment (comment, date_change)
values ('be or not to be?', '2019-05-28 14:05:06'::timestamp);
insert into itemComment (comment, date_change)
values ('Оставь надежду, всяк сюда входящий', '2019-05-28 14:05:06'::timestamp);
insert into itemComment (comment, date_change)
values ('Abandon all hope, ye who enter here', '2019-05-28 14:05:06'::timestamp);
create table item
(
...
insert into catalogItem (id_user_fk, id_item_fk)
values ('2', '2');
insert into catalogItem (id_user_fk, id_item_fk)
values ('2', '3');
