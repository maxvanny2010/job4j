...
public class UserConvert {
    ...
    final Map<Integer, User> process(final List<User> list) {
        ...
        final HashMap<Integer, User> collect = list.stream()
                .collect(Collectors
     ...
     * @return the Map this users
     */
    final Map<Integer, User> processToMap(final List<User> list) {
        return list.stream()
                .collect(Collectors
                        //@param keyMapper a mapping function to produce keys
                        .toMap(User::getId,
